			...
			<div className='flex lg:flex-row flex-col justify-center items-center bg-white lg:p-5 p-3 lg:w-4/5 w-full'>
					...
					<div className='flex justify-center items-center flex-col border-2 border-dotted border-gray-300 p-3 w-full h-420'>
						...
						{!imageAsset ? (
							...
							<div className='relative h-full'>
								...
								<button
									type='button'
									className='absolute bottom-3 right-3 p-3 rounded-full bg-white tex-xl cursor-pointer outline-none hover:shadow-md transition-all duration-500 ease-in-out'
				...
				<div className='flex flex-1 flex-col gap-6 lg:p-5 mt-5 w-full'>
					...
					<div className='flex flex-col'>
						<div>
							<p className='mb-2 font-semibold text-lg sm:text-xl'>Choose Pic Category</p>
							<select
								onChange={(e) => setCategory(e.target.value)}
								className='outline-none w-4/5 text-base capitalize border-b-2 border-gray-200 p-2 rounded-md cursor-pointer'
							>
